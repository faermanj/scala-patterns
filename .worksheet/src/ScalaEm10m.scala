...
* - E dai?
**/
object ScalaEm10m {;import org.scalaide.worksheet.runtime.library.WorksheetSupport._; def main(args: Array[String])=$execute{;$skip(308); 
  ...
  def data = new ByteArrayInputStream(
    """
  	...
  	""".getBytes);System.out.println("""data: => java.io.ByteArrayInputStream""");$skip(90); 
  val doc = DocumentBuilderFactory
  	.newInstance
  	.newDocumentBuilder
  	.parse(data);System.out.println("""doc  : org.w3c.dom.Document = """ + $show(doc ));$skip(112); 
  ...
  for (node <- nodeList) println(node.getTextContent());$skip(159); 
  ...
  import scala.io.Source;$skip(340); 
  ...
  data.aplica(destagueia);System.out.println("""res0: String = """ + $show(res$0));$skip(59); 
  ...
  Thread.sleep(3000)
	...
	import scala.util.Random._;$skip(158); 
